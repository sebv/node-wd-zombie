...
(function() {
  var Browser, MODIFIER_KEYS, MODIFIER_KEY_ARRAY, SPECIAL_KEYS, SPECIAL_KEY_ARRAY, convertCookie, elFuncFullType, elFuncSuffix, elementFuncTypes, fs, k, newError, protocol, uuid, v, wait, waitAfterExecute, waitAfterPage, waitForConditionImpl, waitForConditionInBrowserJsScript, waitForOp, _fn, _i, _len, _newModifierKeys, _querySelectorAllOrNull, _querySelectorOrNull, _rawText, _rawType, _searchType, _transformRes,
    __slice = [].slice,
  ...
  protocol.init = function(desired, done) {
  ...
  protocol.element = function(searchType, value, done) {
    return this.elementOrNull.apply(this, [
      searchType, value, function(err, res) {
        if (err != null) {
          return done(err);
        } else if (!(res != null)) {
