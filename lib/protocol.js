...
(function() {
  var ASCII_SPECIAL_KEYS, Browser, MODIFIER_KEYS, MODIFIER_KEY_ARRAY, SPECIAL_KEYS, SPECIAL_KEY_ARRAY, convertCookie, elFuncFullType, elFuncSuffix, elementFuncTypes, fs, k, newError, protocol, uuid, v, wait, waitAfterExecute, waitAfterPage, waitForConditionImpl, waitForConditionInBrowserJsScript, waitForOp, _fn, _getAsciiVirtualKey, _i, _len, _newModifierKeys, _querySelectorAllOrNull, _querySelectorOrNull, _rawText, _rawType, _searchType, _transformRes,
    __slice = [].slice,
  ...
  protocol.init = function() {
    ...
    this.modifierKeys = _newModifierKeys().reset();
  ...
  protocol.status = function(done) {
    return done(null, {
      status: 'OK'
    });
  };

  protocol.sessions = function(done) {
    return done(null, {
      '1': {
        browserName: 'zombie',
        headless: true,
  ...
  protocol.sessionCapabilities = function(done) {
  ...
  protocol.altSessionCapabilities = function(done) {
    if ((this.browser != null)) {
      return done(null, {
        browserName: 'zombie',
        headless: true,
  ...
  protocol.setPageLoadTimeout = function(ms, done) {
    this.pageLoadTimeout = ms;
    return done(null);
  };

  protocol.setAsyncScriptTimeout = function(ms, done) {
    this.asyncScriptTimeout = ms;
    return done(null);
  };

  protocol.setImplicitWaitTimeout = function(ms, done) {
    this.implicitWaiTimeout = ms;
    return done(null);
  };

  protocol.setSyncScriptTimeout = function(ms, done) {
  ...
  protocol["eval"] = function(code, done) {
    var res;
    res = null;
    try {
  ...
  protocol.execute = function(code, args, done) {
    var res, script, _ref;
    if (!(done != null)) {
  ...
  protocol.executeAsync = function(code, args, done) {
  ...
  _querySelectorOrNull = function(sel, done) {
    var _this = this;
  ...
  protocol.elementOrNull = function(searchType, value, done) {
    switch (searchType) {
      case "class name":
        return _querySelectorOrNull.apply(this, ["." + value, done]);
      case "css selector":
        return _querySelectorOrNull.apply(this, [value, done]);
      case "id":
        return _querySelectorOrNull.apply(this, ["#" + value, done]);
      case "name":
        return _querySelectorOrNull.apply(this, ["[name='" + value + "']", done]);
      case "link text":
      case "partial link text":
      case "tag name":
      case "xpath":
        return protocol.elements.apply(this, [
          searchType, value, function(err, res) {
            if (err != null) {
              done(err);
            }
  ...
  protocol.element = function(searchType, value, done) {
    return protocol.elementOrNull.apply(this, [
      searchType, value, function(err, res) {
        if (err != null) {
          return done(err);
        } else if (!(res != null)) {
  ...
  protocol.elementIfExists = function(searchType, value, done) {
    return protocol.elementOrNull.apply(this, [
      searchType, value, function(err, res) {
        if (err != null) {
          return done(err);
  ...
  protocol.hasElement = function(searchType, value, done) {
    return protocol.elementOrNull.apply(this, [
      searchType, value, function(err, res) {
        if (err != null) {
          return done(err);
  ...
  _querySelectorAllOrNull = function(sel, done) {
    var _this = this;
    return waitForOp.apply(this, [
      function() {
        var rawRes, res;
  ...
  protocol.elements = function(searchType, value, done) {
    var _done,
      _this = this;
    _done = done;
    ...
    switch (searchType) {
      case "class name":
        return _querySelectorAllOrNull.apply(this, ["." + value, done]);
      case "css selector":
        return _querySelectorAllOrNull.apply(this, [value, done]);
      case "id":
        return _querySelectorAllOrNull.apply(this, ["#" + value, done]);
      case "name":
        return _querySelectorAllOrNull.apply(this, ["[name='" + value + "']", done]);
      case "link text":
        return waitForOp.apply(this, [
          function() {
            var rawRes, res, val;
  ...
  _fn = function() {
    ...
    protocol["element" + (elFuncSuffix(searchType))] = function(value, cb) {
      return protocol.element.apply(this, [elFuncFullType(searchType), value, cb]);
    };
    protocol["element" + (elFuncSuffix(searchType)) + "OrNull"] = function(value, cb) {
      return protocol.elementOrNull.apply(this, [elFuncFullType(searchType), value, cb]);
    };
    protocol["element" + (elFuncSuffix(searchType)) + "IfExists"] = function(value, cb) {
      return protocol.elementIfExists.apply(this, [elFuncFullType(searchType), value, cb]);
    };
    protocol["hasElement" + (elFuncSuffix(searchType))] = function(value, cb) {
      return protocol.hasElement.apply(this, [elFuncFullType(searchType), value, cb]);
    };
    return protocol["elements" + (elFuncSuffix(searchType))] = function(value, cb) {
      return protocol.elements.apply(this, [elFuncFullType(searchType), value, cb]);
    };
  };
  ...
  protocol.getAttribute = function(element, attrName, done) {
    var _this = this;
    return waitForOp.apply(this, [
      function() {
        var attrValue;
  ...
  protocol.getValue = function(element, done) {
    var _this = this;
    return waitForOp.apply(this, [
      function() {
        var value;
  ...
  _rawText = function(element, done) {
    var _this = this;
    return waitForOp.apply(this, [
      function() {
        var value;
  ...
  protocol.text = function(element, done) {
    if ((!(element != null)) || (element === 'body')) {
      return protocol.elementByTagName.apply(this, [
        'body', function(err, rootEl) {
          if (err != null) {
            return done(err);
          }
          return _rawText.apply(this, [rootEl, done]);
        }
      ]);
    } else {
      return _rawText.apply(this, [element, done]);
    }
  };

  protocol.textPresent = function(text, element, done) {
    return protocol.text.apply(this, [
      element, function(err, elText) {
        var res;
        if (err != null) {
          return done(err);
        }
  ...
  protocol.clickElement = function(element, done) {
    var _this = this;
  ...
  protocol.buttonDown = function(done) {
    var activeEl,
      _this = this;
  ...
  protocol.buttonUp = function(done) {
    var activeEl,
      _this = this;
    activeEl = this.browser.document.active;
  ...
  protocol.doubleclick = function(done) {
    var activeEl, evObj;
    activeEl = this.browser.document.active;
    evObj = this.browser.document.createEvent('MouseEvents');
  ...
  _getAsciiVirtualKey = function(specialKey) {
    var virtualKeyName;
    virtualKeyName = null;
    for (k in SPECIAL_KEYS) {
      v = SPECIAL_KEYS[k];
  ...
  _rawType = function(element, texts, done) {
  ...
  protocol.type = function(element, texts, done) {
    var _this = this;
    if (!(texts instanceof Array)) {
      texts = [texts];
    }
    this.modifierKeys.reset();
    return _rawType.apply(this, [
  ...
  protocol.keys = function(texts, done) {
    var element,
      _this = this;
    if (!(texts instanceof Array)) {
      texts = [texts];
  ...
  protocol.clear = function(element, done) {
    try {
      element.value = '';
    } catch (err) {
      if (err != null) {
  ...
  protocol.dismissAlert = function(done) {
    return done(null);
  };

  protocol.acceptAlert = function(done) {
    return done(null);
  };

  protocol.deleteAllCookies = function(done) {
    try {
  ...
  protocol.allCookies = function(done) {
  ...
  protocol.setCookie = function(cookie, done) {
  ...
  protocol.deleteCookie = function(name, done) {
    try {
  ...
  waitForConditionImpl = function(conditionExpr, limit, poll, cb) {
    ...
    _this = this;
    if (Date.now() < limit) {
      return protocol.safeEval.apply(_this, [
        conditionExpr, function(err, res) {
          if (err != null) {
            return cb(err);
          }
          if (res === true) {
  ...
  protocol.waitForConditionInBrowser = function() {
    ...
    poll = poll || this.pollMs;
    return protocol.safeExecuteAsync.apply(this, [
      waitForConditionInBrowserJsScript, [conditionExpr, timeout, poll], function(err, res) {
        if (err != null) {
          return cb(err);
        }
        if (res !== true) {
  ...
  protocol.zombieBrowser = function(done) {
    return done(null, this.browser);
  };
