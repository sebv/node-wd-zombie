...
(function() {
  var ASCII_SPECIAL_KEYS, Browser, EventEmitter, MODIFIER_KEYS, MODIFIER_KEY_ARRAY, SPECIAL_KEYS, SPECIAL_KEY_ARRAY, Webdriver, convertCookie, elFuncFullType, elFuncSuffix, elementFuncTypes, fs, getAsciiVirtualKey, k, newError, newModifierKeys, querySelectorAllOrNull, querySelectorOrNull, rawText, rawType, transformRes, uuid, v, wait, waitAfterExecute, waitAfterPage, waitForConditionImpl, waitForConditionInBrowserJsScript, waitForOp, _fn, _i, _len, _searchType,
