...
(function() {
  ...
  runTestWith = function(remoteWdConfig, desired) {
    ...
    return {
        ...
        return browser.elementByCss("#type input", function(err, inputField) {
          ...
          return async.series([
            function(done) {
              ...
              return browser.type(inputField, wd.SPECIAL_KEYS.Return, function(err) {
                should.not.exist(err);
                return done(null);
              });
            }, function(done) {
        ...
        return browser.elementByCss("#keys input", function(err, inputField) {
          ...
          return async.series([
            function(done) {
              ...
              return browser.keys(wd.SPECIAL_KEYS.Return, function(err) {
                should.not.exist(err);
                return done(null);
              });
            }, function(done) {
      ...
      "allCookies / setCookie / deleteAllCookies / deleteCookie": function(test) {
        return async.series([
          function(done) {
